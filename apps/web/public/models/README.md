...
3. With the zip downloaded, replace entirely the contents of "emotion" folder, add the onnx file must be renamed as "model_int8_quantized.onnx", remove the other (bigger) onnx file
